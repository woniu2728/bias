...
function discussionCopyDefinitions() {
  return [
    textCopy('discussion-create-title', 10, '正在打开讨论编辑器...'),
    textCopy('discussion-create-description', 20, '系统会自动切换到浮层编辑器。'),
    textCopy('home-hero-title', 479, 'Bias'),
    textCopy('home-hero-description', 479, '基于 Django 和 Vue 3 的现代化论坛'),
    textCopy('home-browse-discussions', 479, '浏览讨论'),
    textCopy('home-start-discussion', 479, '发起讨论'),
    textCopy('home-register-account', 479, '注册账号'),
    {
    ...
    textCopy('discussion-action-confirm-cancel', 479, '取消'),
    textCopy('discussion-action-confirm-default', 479, '继续'),
    {
    ...
    textCopy('discussion-action-login-label', 479, '登录后回复'),
    textCopy('discussion-action-login-description', 479, '登录后才可以参与当前讨论。'),
    textCopy('discussion-action-edit-label', 479, '编辑讨论'),
    textCopy('discussion-action-edit-description', 479, '修改标题和正文。'),
    {
    ...
    textCopy('discussion-action-toggle-pin-confirm-title', 479, '置顶讨论'),
    textCopy('discussion-action-toggle-pin-confirm-message', 479, '确定将这条讨论置顶吗？'),
    textCopy('discussion-action-toggle-pin-confirm-confirm', 479, '置顶讨论'),
    {
    ...
    textCopy('discussion-action-toggle-lock-confirm-title', 479, '锁定讨论'),
    textCopy('discussion-action-toggle-lock-confirm-message', 479, '确定锁定当前讨论并阻止普通用户继续回复吗？'),
    textCopy('discussion-action-toggle-lock-confirm-confirm', 479, '锁定讨论'),
    {
    ...
    textCopy('discussion-action-delete-label', 479, '删除讨论'),
    textCopy('discussion-action-delete-description', 479, '永久删除当前讨论及其回复。'),
    textCopy('discussion-action-delete-confirm-title', 479, '删除讨论'),
    textCopy('discussion-action-delete-confirm-message', 479, '确定要删除这个讨论吗？此操作不可恢复。'),
    textCopy('discussion-action-delete-confirm-confirm', 479, '删除'),
    textCopy('discussion-sidebar-active-draft', 479, '当前讨论已有未发布回复草稿。'),
    textCopy('discussion-sidebar-locked', 479, '当前讨论已锁定，暂时无法继续回复。'),
    textCopy('discussion-sidebar-suspension-title', 479, '账号状态'),
    textCopy('discussion-sidebar-scrubber-start', 479, '原帖'),
    textCopy('discussion-sidebar-scrubber-end', 479, '现在'),
    textCopy('discussion-detail-suspension-alert-title', 479, '账号已被封禁'),
    {
    ...
    textCopy('discussion-detail-action-retry-message', 479, '请稍后重试'),
    textCopy('discussion-detail-unknown-time', 479, '未知时间'),
    {
    ...
    textCopy('discussion-list-sidebar-profile-link', 479, '我的主页'),
    {
    ...
    textCopy('discussion-list-action-retry-message', 479, '请稍后重试'),
    {
    ...
    textCopy('discussion-event-renamed-from-label', 479, '将讨论标题从'),
    textCopy('discussion-event-renamed-to-label', 479, '改为'),
    textCopy('discussion-event-renamed-old-title-fallback', 479, '旧标题'),
    textCopy('discussion-event-renamed-new-title-fallback', 479, '新标题'),
    textCopy('discussion-generic-event-fallback-label', 479, '系统事件'),
    {
    ...
    textCopy('discussion-post-edited-label', 479, '已编辑'),
    textCopy('discussion-post-reply-action', 479, '回复'),
    {
    ...
    textCopy('mobile-drawer-start-discussion', 500, '发起讨论'),
    textCopy('mobile-drawer-all-discussions', 510, '全部讨论'),
    textCopy('discussion-composer-title-placeholder', 580, '讨论标题'),
    textCopy('discussion-composer-content-placeholder', 590, '输入讨论内容... 支持 Markdown、@用户名 和代码块'),
    {
    ...
    textCopy('discussion-composer-close-title', 614, '关闭发帖编辑器'),
    textCopy('discussion-composer-close-message', 615, '确定要关闭发帖编辑器吗？当前内容会保留在本地草稿中。'),
    textCopy('discussion-composer-close-confirm', 616, '关闭'),
    textCopy('discussion-composer-close-cancel', 617, '继续编辑'),
    {
    ...
    textCopy('discussion-composer-draft-restore-error', 619, '讨论草稿恢复失败，已保留当前编辑内容。'),
    textCopy('discussion-composer-draft-emptied', 620, '草稿已清空'),
    textCopy('discussion-composer-draft-saved', 621, '讨论草稿已保存。'),
    textCopy('discussion-composer-clear-draft-title', 622, '清除讨论草稿'),
    textCopy('discussion-composer-clear-draft-message', 623, '确定要清除当前讨论草稿吗？'),
    textCopy('discussion-composer-clear-draft-confirm', 624, '清除'),
    textCopy('discussion-composer-clear-draft-cancel', 625, '取消'),
    textCopy('discussion-composer-draft-cleared-local', 626, '已清除本地草稿。'),
    textCopy('discussion-composer-unsaved-exit-message', 626, '你有未发布的讨论内容。确定要离开当前页面吗？'),
    textCopy('discussion-composer-updated-title', 629, '讨论已更新'),
    textCopy('discussion-composer-updated-message', 630, '新的讨论内容已经保存。'),
    textCopy('discussion-detail-load-previous', 1130, '加载前面的回复'),
    textCopy('discussion-detail-load-more', 1160, '加载更多回复'),
    textCopy('discussion-detail-load-posts-loading', 1150, '正在加载回复...'),
    textCopy('discussion-detail-unread-divider', 1160, '从这里开始是未读回复'),
    {
    ...
    textCopy('discussion-list-refreshing', 1200, '正在刷新讨论'),
    textCopy('discussion-list-load-more', 1200, '加载更多讨论'),
    textCopy('discussion-list-loading-more', 1200, '正在加载讨论...'),
    {
