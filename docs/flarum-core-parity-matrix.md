...
1. 扩展 discussion/post 的 HTTP 集成覆盖。
   ...
   - 下一步继续补用户资料、通知等剩余浏览器流程，并继续收敛用户/通知相关 HTTP 矩阵。
