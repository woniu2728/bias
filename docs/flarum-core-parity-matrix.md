...
1. 扩展 discussion/post 的 HTTP 集成覆盖。
   ...
   - 下一步继续补用户资料浏览器流程，并继续收敛通知触发、删除、筛选刷新和用户相关 HTTP 矩阵。
